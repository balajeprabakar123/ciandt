...
public class SharedContext {
    ...
    private final String CHROME_DRIVER_VERSION = "2.40";
    ...
    public void setUp() throws Exception {
        ...
        if (isLocalEnv()) {
            ...
            String chromeDriver = "C:\\JavaProj\\learnmake-cucumber-selenium-master\\drivers\\88\\chromedriver.exe";
    ...
    private RemoteWebDriver initBrowserDriver(Browser browser) {
        ...
        if (browser.equals(Browser.chrome)) {
            ...
            System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\drivers\\88\\chromedriver.exe");
